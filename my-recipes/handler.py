...
<head>
    <title>{% block title %}RenderMd{% endblock %}</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Render my Markdown Wiki">
    <link type="text/css" rel="stylesheet" href="{{ url_for('static', filename='css/github_md.css') }}">
...
.markdown-body h6:hover .anchor .octicon-link:before {
  ...
  color: #24292e;
  /* font-family: Ubuntu Mono Nerd Font Complete Mono,-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; */
...
.markdown-body kbd {
  display: inline-block;
  padding: 3px 5px;
  font: 9px SFMono-Regular,Consolas,Liberation Mono,Menlo,monospace;
  line-height: 10px;
  color: #444d56;
  vertical-align: middle;
